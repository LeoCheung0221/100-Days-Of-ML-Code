...
旧的概念问答在 [`archive/2019`](archive/2019)。
...
代码在 [`days/01-line-that-misses`](days/01-line-that-misses)。
...
前一天还能用的偷懒办法，下一天收走一个。升高的是约束，不是库的名字。

### 01 – 10 · 误差

| 天 | 实战 | 新收走的办法 |
|---|---|---|
| 01 | 死记对上直线。第四天收在 20，直线失手 8.2 | 起点。两种做法必须并排 |
