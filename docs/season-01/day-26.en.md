...
**Replication.** Cite 0.4583 with seed 1, train fraction 0.70, lagged-return design, and test-row sign metric only. Do not call it walk-forward until day 27 prints the time split beside it. Day 25's 0.4675 is a different full-sample rule.
