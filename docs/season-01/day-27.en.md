...
**Protocols.** Time split 0.5417 uses a test block entirely after train; random 0.4583 allows calendar inversion. Single-name AAA comparison only—day 37's pooled split is a different subject. The 0.0834 gap is not a p-value.
