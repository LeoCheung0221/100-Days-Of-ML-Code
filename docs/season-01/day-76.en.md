...
Day 76 prints 2 contract lines:

- `missed down days = 3`: match the terminal verbatim—keys, spacing, signs, six decimals.
- `false alarm up days = 3`: match the terminal verbatim—keys, spacing, signs, six decimals.
