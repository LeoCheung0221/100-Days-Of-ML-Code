...
What you learn today: Same rules as day 75: line bill −18, tree bill −27; lower bill wins line

## Plain-language account

Same billing as day 75: line −18 beats tree −27.

Aligns with MSE story; report both.
...
Day 79 lower bill wins: line −18.0000 beats tree −27.0000.
...
The script should print stdout matching the core block. Implementation: [`billed_ranking.py`](../../days/79-billed-ranking/billed_ranking.py).
