...
Day 80 prints 4 contract lines:

- `acceptable mistake = direction wrong at cost 1`: match the terminal verbatim—keys, spacing, signs, six decimals.
- `direction wrong days = 3`: match the terminal verbatim—keys, spacing, signs, six decimals.
- `jump days billed at 3 = 5`: match the terminal verbatim—keys, spacing, signs, six decimals.
- `this choice names column direction wrong in the bill table`: match the terminal verbatim—keys, spacing, signs, six decimals.
